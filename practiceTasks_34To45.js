...
for (i=0;i<shirt_sizes.length;i++)
{
    ...
    make_shirt(shirt_sizes[i],message);
...
//Task 38
let cities=['Karachi', 'Lahore', 'Istanbul', 'Islamabad'];
function describe_city(city, country='Pakistan')   
{
    console.log('%s is in %s.', city,country );
  
}
describe_city(cities[0]);
describe_city(cities[1]);
describe_city(cities[2], 'Türkiye');
...
copy_magicians=[...magicians]; //copy of magicians
...
function cars(manufacturerName, modelName, ...otherInfo) 
{
...
console.log(cars('Toyota','Platz',carFeatures, carRegistrationInfo));
