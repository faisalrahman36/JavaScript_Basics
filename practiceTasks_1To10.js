...
let message="Intelligence is the ability to adapt to change.";
console.log('%s once said, “%s”',famous_person,message);

//Task 6
let personName2= "  Syed\tFaisal ur \n Rahman      "
...
num1=5; //number 1
num2=10; //number 2
num3=num1 + num2; //adding numbers 1 and 2
